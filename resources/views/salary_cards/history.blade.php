...
@section('content')
    ...
    @endphp
    <div class="container">
        <h1>History for Salary Card #{{ $salaryCard->id }}</h1>
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($history->old_values)
                                <ul>
                                    <li><strong>User ID:</strong> {{ $history->old_values['user_id'] ?? 'N/A' }}</li>
        ...
        <!-- Back Button -->
        <a href="{{ route('salary-cards.index') }}" class="btn btn-secondary">Back to Salary Cards</a>
    </div>
@endsection
